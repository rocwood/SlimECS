...
namespace SlimECS
{
	public struct EntityQueryAllBuilder<T1> where T1:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1> Get()
			=> (EntityQueryAll<T1>)_context.GetQuery(typeof(EntityQueryAll<T1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAllBuilder<T1,T2> where T1:struct,IComponent where T2:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2> Get()
			=> (EntityQueryAll<T1,T2>)_context.GetQuery(typeof(EntityQueryAll<T1,T2>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1,T2>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1,T2>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAllBuilder<T1,T2,T3> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3> Get()
			=> (EntityQueryAll<T1,T2,T3>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1,T2,T3>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAllBuilder<T1,T2,T3,T4> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4> Get()
			=> (EntityQueryAll<T1,T2,T3,T4>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3,T4>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1,T2,T3,T4>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3,T4>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAllBuilder<T1,T2,T3,T4,T5> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent where T5:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4,T5>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1,T2,T3,T4,T5>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3,T4,T5>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4,T5>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAllBuilder<T1,T2,T3,T4,T5,T6> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent where T5:struct,IComponent where T6:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4,T5,T6>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAll<T1,T2,T3,T4,T5,T6>.Without<X1>)_context.GetQuery(typeof(EntityQueryAll<T1,T2,T3,T4,T5,T6>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAll<T1,T2,T3,T4,T5,T6>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1> where T1:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1> Get()
			=> (EntityQueryAny<T1>)_context.GetQuery(typeof(EntityQueryAny<T1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1,T2> where T1:struct,IComponent where T2:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2> Get()
			=> (EntityQueryAny<T1,T2>)_context.GetQuery(typeof(EntityQueryAny<T1,T2>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1,T2>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1,T2>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1,T2,T3> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3> Get()
			=> (EntityQueryAny<T1,T2,T3>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1,T2,T3>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1,T2,T3,T4> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4> Get()
			=> (EntityQueryAny<T1,T2,T3,T4>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3,T4>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1,T2,T3,T4>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3,T4>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1,T2,T3,T4,T5> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent where T5:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4,T5>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1,T2,T3,T4,T5>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3,T4,T5>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4,T5>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
	...
	public struct EntityQueryAnyBuilder<T1,T2,T3,T4,T5,T6> where T1:struct,IComponent where T2:struct,IComponent where T3:struct,IComponent where T4:struct,IComponent where T5:struct,IComponent where T6:struct,IComponent 
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4,T5,T6>.Without<X1> Without<X1>() where X1:struct,IComponent 
			=> (EntityQueryAny<T1,T2,T3,T4,T5,T6>.Without<X1>)_context.GetQuery(typeof(EntityQueryAny<T1,T2,T3,T4,T5,T6>.Without<X1>));
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public EntityQueryAny<T1,T2,T3,T4,T5,T6>.Without<X1,X2> Without<X1,X2>() where X1:struct,IComponent where X2:struct,IComponent 
